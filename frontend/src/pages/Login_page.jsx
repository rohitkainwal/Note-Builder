...
const Login_page = () => {
  ...
  return (
    ...
    <Navbar/>
    <div className="min-h-screen bg-gradient-to-br from-gray-100 via-gray-50 to-stone-100 flex items-center justify-center p-4">
      <div className="w-full max-w-6xl bg-white rounded-3xl shadow-2xl overflow-hidden flex">
        ...
        <div className="w-full lg:w-1/2 p-8 lg:p-10">
          ...
          <div className="mb-6">
            ...
            <p className="text-gray-500 text-sm">Sign in and get 30 day free trial</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full bg-[rgb(var(--color-primary))] hover:bg-[rgb(var(--color-primary))]  text-gray-900 font-semibold py-3 rounded-full transition duration-300 transform active:scale-[0.98] shadow-md hover:shadow-lg mt-6"
            >
              Submit
            </button>
          </form>
          ...
          <p className="mt-6 text-xs text-gray-500 text-center">
            Don't have an account? <Link to="/register" className="text-gray-900 font-medium underline">Sign up</Link>
          </p>
